...
for rep in range(1):
    ...
    def make_federated_data(client_data, client_ids):
      print(client_data)
      return [
          preprocess(client_data.create_tf_dataset_for_client(client_ids[i]).concatenate(client_data.create_tf_dataset_for_client(client_ids[i+1])))
          for i in range(0, len(client_ids), 2)
      ]

    sample_clients = emnist_train.client_ids[0:NUM_CLIENTS*2]
