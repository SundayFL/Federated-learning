...
def main():
    ...
    print(f"Use virtual: {args.use_virtual}")
    if args.use_virtual:
    ...
    results = grid.search("#mnist")
    print(f"Search result: {results.keys()}")

    results1 = alice.search(["#mnist"])
    print(f"Search 2 result: {len(results1)}")
